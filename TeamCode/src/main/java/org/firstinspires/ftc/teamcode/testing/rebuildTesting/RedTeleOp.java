...
public class RedTeleOp extends NextFTCOpMode {
    ...
    public void onStartButtonPressed() {
        ...
        // ── Turret ───────────────────────────────────────────────────────────
        // Left trigger: track the goal while pressed past threshold
        Gamepads.gamepad1().leftTrigger().greaterThan(0.3)
                .whenBecomesTrue(Turret.INSTANCE.track)
                .whenBecomesFalse(Turret.INSTANCE.track::cancel);
    ...
    public void onUpdate() {
        ...
        telemetry.addLine("LT (hold)   : turret goal tracking");
        ...
        telemetry.addData("Tracking Goal",  CommandManager.INSTANCE.hasCommandsUsing(Turret.INSTANCE));
